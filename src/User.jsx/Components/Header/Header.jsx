...
function Header() {
  ...
  return (
    <div className="banner bg-origin-border" style={{ backgroundImage: `url(${data ? data.image : ''})` }}>
      <div className='w-96  ml-6  rounded h-lg p-10  '>
        <div className='shoe-title '><h1 className='text-black'>{data ? data.title : ""}</h1></div>
        <div className='dis'><p className='text-black'>{data ? data.description : ""}</p></div>
